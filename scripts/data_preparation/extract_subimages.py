...
def main():
    ...
    # HR images
    opt['input_folder'] = r'D:\SR_test\SR_data\LSDIR\DL20K'
    opt['save_folder'] = r'D:\SR_test\SR_data\LSDIR\DL20K_train_HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    extract_subimages(opt)
    ...
    # # LRx4 images
    # opt['input_folder'] = r'D:\SR_test\SR_data\LSDIR\DL20K_X4'
    # opt['save_folder'] = r'D:\SR_test\SR_data\LSDIR\DL20K_train_LR_bicubic\X4_sub'
    # opt['crop_size'] = 120
    # opt['step'] = 60
    # opt['thresh_size'] = 0
    # extract_subimages(opt)
